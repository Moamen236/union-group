<div x-data="{saveProfile(){
    ...
    <!-- Profile Info Modal -->
    <div x-data="{ open: false }" @open-profile-info-modal.window="open = true"
        x-show="open"
        ...
        class="fixed inset-0 z-99999 flex items-center justify-center overflow-y-auto bg-gray-900/50 p-4 dark:bg-gray-900/80"
        style="display: none;">
        <div
            ...
            class="relative w-full max-w-[700px] rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
            <button @click="open = false" class="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700">
