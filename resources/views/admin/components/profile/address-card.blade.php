<div x-data="{saveProfile(){
    ...
    <div x-data="{ open: false }" @open-profile-address-modal.window="open = true" x-show="open" x-cloak @keydown.escape.window="open = false"
        ...
        <!-- Modal Content -->
        <div @click.stop class="relative w-full rounded-3xl bg-white dark:bg-gray-900 max-w-[700px]"
