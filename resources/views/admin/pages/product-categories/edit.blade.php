...
@section('content')
    @include('admin.components.common.page-breadcrumb', ['pageTitle' => 'Edit Category'])
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <form action="{{ route('admin.product-categories.update', $productCategory) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="space-y-6">
                    ...
                    @include('admin.components.form.textarea-group', [
                        ...
                        'value' => $productCategory->description_en,
                ...
                <div class="space-y-6">
                    ...
                    @include('admin.components.form.textarea-group', [
                        ...
                        'value' => $productCategory->description_ar,
            ...
            <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                    @include('admin.components.form.image-upload', [
                        ...
                        'currentImage' => $productCategory->imageUrl,
