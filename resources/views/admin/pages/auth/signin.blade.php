                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" placeholder="info@gmail.com"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border {{ $errors->has('email') ? 'border-error-500' : 'border-gray-300' }} bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        @error('email')
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="{{ asset('admin/images/logo/auth-logo.png') }}" alt="Logo" />
                        </a>
