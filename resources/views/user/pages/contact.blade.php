        ...
        <div class="contact-form">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <!--======= FORM  =========-->
              <form role="form" id="contact_form" class="contact-form" method="post" action="{{ route('user.contact.submit') }}">
                @csrf
                <ul class="row">
                  <li class="col-sm-6">
                    <label>full name *
                  ...
                  <li class="col-sm-12">
                    <button type="submit" class="btn" id="btn_submit">SEND MAIL</button>
                  </li>
                </ul>
              </form>
            </div>
