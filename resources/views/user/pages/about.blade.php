...
@section('content')
  ...
  <div id="content">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-10 center-block">
            ...
            <!-- IMG -->
            <img class="img-responsive margin-top-80 margin-bottom-80" src="{{ asset('user/images/about-img.jpg') }}" alt="">
    ...
    <!-- Video -->
    <section class="video-block"> <img class="img-responsive" src="{{ asset('user/images/video-img.jpg') }}" alt="" >
      ...
      <div class="container">
        ...
        <ul class="row">
          ...
          <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.4s">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-1.jpg') }}" alt="" >
                <!-- Team hover -->
          ...
          <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.6s">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-2.jpg') }}" alt="" >
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
          ...
          <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.8s">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-3.jpg') }}" alt="" >
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
          ...
          <li class="col-md-4 text-center">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-4.jpg') }}" alt="" >
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
          ...
          <li class="col-md-4 text-center">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-5.jpg') }}" alt="" >
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
          ...
          <li class="col-md-4 text-center">
            <article>
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{ asset('user/images/team-6.jpg') }}" alt="" >
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
    ...
    <section class="our-team padding-top-150 padding-bottom-100">
      <div class="container">
        ...
        <ul class="clients-img">
          <li> <img class="img-responsive" src="{{ asset('user/images/c-img-1.jpg') }}" alt=""> </li>
          <li> <img class="img-responsive" src="{{ asset('user/images/c-img-2.jpg') }}" alt=""> </li>
          <li> <img class="img-responsive" src="{{ asset('user/images/c-img-3.jpg') }}" alt=""> </li>
          <li> <img class="img-responsive" src="{{ asset('user/images/c-img-4.jpg') }}" alt=""> </li>
        </ul>
      </div>
    </section>
