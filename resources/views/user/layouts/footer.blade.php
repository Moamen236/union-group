...
<footer>
    <div class="container">
        ...
        <div class="col-md-3">
            <h6>{{ __('Contact Us') }}</h6>
            <p>
                <i class="icon-call-end" style="margin: 0 5px"></i> {{ __('Customer Services') }}:
            ...
            <p>
                <i class="icon-call-end" style="margin: 0 5px"></i> {{ __('Sales') }}:
                <a href="tel:01026578943" style="color: inherit;">01026578943</a>,
                <a href="tel:01026347675" style="color: inherit;">01026347675</a>
            </p>
            <p>
                <i class="icon-call-end" style="margin: 0 5px"></i> {{ __('WhatsApp') }}: <a href="https://wa.me/201016194660" target="_blank" style="color: inherit;">01016194660</a>
            </p>
            <p>
